...
namespace Kojiro_ordering_management_system
{
    public partial class AddUsAddress_My : Form
    {
        ...
        private void AddUsAddress_My_Load(object sender, EventArgs e)
        {
            //进入窗口就加载
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            User_side.user_Side.loadform(my_Information);//返回我的界面
        }
